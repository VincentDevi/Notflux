...
export const TvDescription = ({children}) =>{
    ...
    return (
        ...
        <div className="w-full h-auto">
            ...
            <ul className="flex justify-around flex-wrap sm:flex-col sm:h-full sm::w-auto sm:ml-10 sm:justify-end">
                ...
                <li key={index} className="mx-1.5 mt-3 shrink-0 w-24 text-center border-solid border-1 rounded bg-bordeaux text-medium sm:mb-7">{(item.name=="Science Fiction")? "Sci-fi":item.name}</li>
                )}
            </ul>
            </div>
